...
const ray1 = new Ray(Vector.createPosition(0.5, 1.2), Vector.createDirection(1, 0).normalize());
const ray2 = new Ray(Vector.createPosition(-1, 1.2), Vector.createDirection(-1, 1).normalize());
...
const iray1 = new Ray(Vector.createPosition(2, 3), Vector.createDirection(-1, 0).normalize());
const iray2 = new Ray(Vector.createPosition(4, 3), Vector.createDirection(-1, 1).normalize());
