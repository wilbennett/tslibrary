...
export class RK4 extends IntegratorBase {
    ...
    integrate(now: number, step: TimeStep) {
        ...
        const acc1 = this._force.scale(this.massInfo.massInverse);
        ...
        const acc2 = this._force.scale(this.massInfo.massInverse);
