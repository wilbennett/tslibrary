...
export abstract class Matrix {
  ...
  abstract transform(point: Vector, values?: MatrixValues, result?: Vector): Vector;

  transformInverse(point: Vector, result?: Vector): Vector {
    return this.isInverseValid ? this.transform(point, this.inverse, result) : Vector.empty;
  }
